window.PorfolioConfig = {
  ...
  works: [{
    ...
    {
      name: 'Nusantara Web (JS)',
      link: 'https://ahmads-nusantara-web.netlify.app',
  ...
  quotes: [{
    ...
    {
      name: 'Quote 6',
      description: ' "Rasa sakit itu sebenarnya menyadarkan Manusia, dengan adanya rasa sakit itu rasa sakit itulah yg menyadari kita sebenarnya"'
    },
    {
      name: 'Quote 7',
